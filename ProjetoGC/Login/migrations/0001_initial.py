    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contato', models.CharField(blank=True, max_length=20, null=True, unique=True)),
                ('cpf', models.CharField(blank=True, max_length=14, null=True, unique=True)),
                ('endereco', models.TextField(blank=True, null=True, verbose_name='Endereço')),
                ('tipo', models.CharField(choices=[('aluno', 'Aluno'), ('professor', 'Professor'), ('secretaria', 'Secretaria')], max_length=10)),
        ...
        migrations.CreateModel(
            name='Secretaria',
            fields=[
                ('secretaria_id', models.AutoField(primary_key=True, serialize=False)),
