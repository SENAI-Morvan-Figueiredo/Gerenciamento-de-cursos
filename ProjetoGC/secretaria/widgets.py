...
class DataNascimentoWidget(forms.TextInput):
    ...
    def __init__(self, attrs=None):
        default_attrs = {
            ...
            'data-date-mask': 'true',
            'maxlength': '10',
            'onkeypress': 'return dateMask(event)',  # Adiciona evento de máscara
            'oninput': 'applyDateMask(this)'  # Adiciona máscara durante a digitação
        }
        if attrs:
...
# ADICIONE ESTE NOVO WIDGET PARA CAMPOS DE DATA EM GERAL
class DateInputWidget(forms.DateInput):
    """Widget para campos de data com máscara DD/MM/YYYY"""
    ...
    def __init__(self, attrs=None):
        default_attrs = {
            ...
            'class': 'date-input',
            'maxlength': '10',
            'onkeypress': 'return dateMask(event)',
